...
UDB_CLONE_POSITIONS = [
    { "ref":     "D1", "x":      -6.35, "y":      7.042, "rotation":  180.0, "side": "Front", "ref_x":       0.0, "ref_y":       0.0 },
    { "ref":     "F1", "x":     -7.112, "y":      3.359, "rotation":  -90.0, "side": "Front", "ref_x":       0.0, "ref_y":       0.0 },
    { "ref":     "J1", "x":        0.0, "y":        0.0, "rotation":  180.0, "side": "Front", "ref_x":       0.0, "ref_y":       0.0 },
    { "ref":     "R1", "x":      3.048, "y":      7.281, "rotation":  -90.0, "side": "Front", "ref_x":       2.5, "ref_y":       0.0 },
    { "ref":     "R2", "x":     -3.048, "y":      7.281, "rotation":  -90.0, "side": "Front", "ref_x":       2.5, "ref_y":       0.0 },
    { "ref":     "U1", "x":        0.0, "y":     6.1784, "rotation":   90.0, "side": "Front", "ref_x":      -2.0, "ref_y":      -1.5 },
]
UDB_CLONE_TRACKS = [
    { "x1":       -8.0, "y1":      5.647, "x2":     -7.112, "y2":      4.759, "width":      0.508, "layer": "F.Cu" },
    { "x1":       -8.0, "y1":      7.042, "x2":       -8.0, "y2":      5.647, "width":      0.508, "layer": "F.Cu" },
    { "x1":       -8.0, "y1":       7.95, "x2":       -8.0, "y2":      7.042, "width":      0.508, "layer": "F.Cu" },
    { "x1":    -7.5825, "y1":     8.3675, "x2":       -8.0, "y2":       7.95, "width":      0.508, "layer": "F.Cu" },
    { "x1":   -5.87802, "y1":      1.959, "x2":     -7.112, "y2":      1.959, "width":      0.508, "layer": "F.Cu" },
    { "x1":    -5.7715, "y1":     8.3675, "x2":    -7.5825, "y2":     8.3675, "width":      0.508, "layer": "F.Cu" },
    { "x1":     -5.325, "y1":    2.51202, "x2":   -5.87802, "y2":      1.959, "width":      0.508, "layer": "F.Cu" },
    { "x1":     -5.325, "y1":    4.33665, "x2":     -5.325, "y2":    2.51202, "width":      0.508, "layer": "F.Cu" },
    { "x1":     -4.938, "y1":      9.201, "x2":    -5.7715, "y2":     8.3675, "width":      0.508, "layer": "F.Cu" },
    { "x1":   -4.27065, "y1":      5.391, "x2":     -5.325, "y2":    4.33665, "width":      0.508, "layer": "F.Cu" },
    { "x1":     -3.048, "y1":      6.456, "x2":     -2.156, "y2":      6.456, "width":      0.254, "layer": "F.Cu" },
    { "x1":     -2.529, "y1":      9.201, "x2":     -4.938, "y2":      9.201, "width":      0.508, "layer": "F.Cu" },
    { "x1":      -2.45, "y1":       3.72, "x2":      -2.45, "y2":      5.391, "width":      0.508, "layer": "F.Cu" },
    { "x1":      -2.45, "y1":      5.391, "x2":   -4.27065, "y2":      5.391, "width":      0.508, "layer": "F.Cu" },
    { "x1":      -2.45, "y1":      5.391, "x2":       2.45, "y2":      5.391, "width":      0.508, "layer": "B.Cu" },
    { "x1":     -2.156, "y1":      6.456, "x2":      -1.75, "y2":       6.05, "width":      0.254, "layer": "F.Cu" },
    { "x1":      -1.75, "y1":       6.05, "x2":      -1.75, "y2":      4.045, "width":      0.254, "layer": "F.Cu" },
    { "x1":      -1.27, "y1":      7.042, "x2":      -1.27, "y2":      7.423, "width":     0.1524, "layer": "B.Cu" },
    { "x1":      -1.27, "y1":      7.423, "x2":     -1.016, "y2":      7.677, "width":     0.1524, "layer": "B.Cu" },
    { "x1":     -1.016, "y1":      7.677, "x2":     -0.523, "y2":      7.677, "width":     0.1524, "layer": "B.Cu" },
    { "x1":       -1.0, "y1":    5.24083, "x2":      -0.75, "y2":    4.99083, "width":     0.1524, "layer": "F.Cu" },
    { "x1":       -1.0, "y1":     6.5634, "x2":       -1.0, "y2":    5.24083, "width":     0.1524, "layer": "F.Cu" },
    { "x1":       -1.0, "y1":     6.5634, "x2":       -1.0, "y2":      6.772, "width":      0.254, "layer": "F.Cu" },
    { "x1":       -1.0, "y1":      6.772, "x2":      -1.27, "y2":      7.042, "width":      0.254, "layer": "F.Cu" },
    { "x1":      -0.75, "y1":    4.99083, "x2":      -0.75, "y2":      4.045, "width":     0.1524, "layer": "F.Cu" },
    { "x1":     -0.523, "y1":      7.677, "x2":        0.5, "y2":        8.7, "width":     0.1524, "layer": "B.Cu" },
    { "x1":       -0.5, "y1":        5.4, "x2":      -0.25, "y2":       5.15, "width":      0.254, "layer": "F.Cu" },
    { "x1":       -0.5, "y1":        8.7, "x2":       -0.5, "y2":        5.4, "width":      0.254, "layer": "F.Cu" },
    { "x1":      -0.25, "y1":       5.15, "x2":      -0.25, "y2":      4.045, "width":      0.254, "layer": "F.Cu" },
    { "x1":        0.0, "y1":     5.7934, "x2":        0.0, "y2":        7.4, "width":      0.254, "layer": "F.Cu" },
    { "x1":     0.0022, "y1":     9.2022, "x2":       -0.5, "y2":        8.7, "width":     0.1524, "layer": "B.Cu" },
    { "x1":       0.25, "y1":       5.15, "x2":       0.25, "y2":      4.045, "width":      0.254, "layer": "F.Cu" },
    { "x1":        0.5, "y1":        5.4, "x2":       0.25, "y2":       5.15, "width":      0.254, "layer": "F.Cu" },
    { "x1":        0.5, "y1":        8.7, "x2":        0.5, "y2":        5.4, "width":      0.254, "layer": "F.Cu" },
    { "x1":    0.70802, "y1":     9.2022, "x2":     0.0022, "y2":     9.2022, "width":     0.1524, "layer": "B.Cu" },
    { "x1":       0.75, "y1":    4.99083, "x2":       0.75, "y2":      4.045, "width":     0.1524, "layer": "F.Cu" },
    { "x1":        1.0, "y1":    5.24083, "x2":       0.75, "y2":    4.99083, "width":     0.1524, "layer": "F.Cu" },
    { "x1":        1.0, "y1":     6.5634, "x2":        1.0, "y2":    5.24083, "width":     0.1524, "layer": "F.Cu" },
    { "x1":        1.0, "y1":     6.5634, "x2":        1.0, "y2":      6.772, "width":      0.254, "layer": "F.Cu" },
    { "x1":        1.0, "y1":      6.772, "x2":       1.27, "y2":      7.042, "width":      0.254, "layer": "F.Cu" },
    { "x1":       1.25, "y1":      4.045, "x2":       1.25, "y2":     4.9192, "width":      0.254, "layer": "F.Cu" },
    { "x1":       1.25, "y1":     4.9192, "x2":      1.722, "y2":     5.3912, "width":      0.254, "layer": "F.Cu" },
    { "x1":       1.27, "y1":      7.042, "x2":       1.27, "y2":    8.64022, "width":     0.1524, "layer": "B.Cu" },
    { "x1":       1.27, "y1":    8.64022, "x2":    0.70802, "y2":     9.2022, "width":     0.1524, "layer": "B.Cu" },
    { "x1":      1.722, "y1":     5.3912, "x2":      1.722, "y2":      5.972, "width":      0.254, "layer": "F.Cu" },
    { "x1":      1.722, "y1":      5.972, "x2":      2.206, "y2":      6.456, "width":      0.254, "layer": "F.Cu" },
    { "x1":      2.206, "y1":      6.456, "x2":      3.048, "y2":      6.456, "width":      0.254, "layer": "F.Cu" },
    { "x1":       2.45, "y1":       3.72, "x2":       2.45, "y2":      5.391, "width":      0.508, "layer": "F.Cu" },
]
UDB_CLONE_VIAS = [

...
V2_TRACKS = [
    ...
    { "x1":   -11.4105, "y1":        2.6, "x2":    -8.0025, "y2":        2.6, "width":   0.2, "layer": 31 },
    { "x1":    -7.1025, "y1":        1.7, "x2":    -7.1025, "y2":        1.6, "width":   0.2, "layer": 31 },
    ...
    { "x1":    -8.0025, "y1":        2.6, "x2":    -7.1025, "y2":        1.7, "width":   0.2, "layer": 31 },
    ...
    { "x1":    23.7865, "y1":   -3.06835, "x2":    23.7365, "y2":   -3.01835, "width":   0.2, "layer": 31 },
    { "x1":    24.7365, "y1":   -2.19335, "x2":    24.7365, "y2":   -3.01835, "width":   0.2, "layer": 31 },
    { "x1":    24.6865, "y1":   -3.06835, "x2":    23.7865, "y2":   -3.06835, "width":   0.2, "layer": 31 },
    { "x1":    23.7365, "y1":   -3.01835, "x2":    23.7365, "y2":   -2.19335, "width":   0.2, "layer": 31 },
    { "x1":    23.7365, "y1":    -0.0525, "x2":     23.349, "y2":      0.335, "width":   0.2, "layer": 31 },
    { "x1":    23.7365, "y1":   -2.19335, "x2":    23.7365, "y2":    -0.0525, "width":   0.2, "layer": 31 },
    { "x1":    24.7365, "y1":   -3.01835, "x2":    24.6865, "y2":   -3.06835, "width":   0.2, "layer": 31 },
    { "x1":    25.1865, "y1":   -1.31835, "x2":    25.2365, "y2":   -1.36835, "width":   0.2, "layer": 31 },
    { "x1":    25.2365, "y1":   -2.19335, "x2":    25.2365, "y2":    -0.0525, "width":   0.2, "layer": 31 },
    { "x1":    25.2365, "y1":    -0.0525, "x2":     25.624, "y2":      0.335, "width":   0.2, "layer": 31 },
    ...
    { "x1":    24.2365, "y1":   -1.36835, "x2":    24.2865, "y2":   -1.31835, "width":   0.2, "layer": 31 },
    { "x1":    24.2865, "y1":   -1.31835, "x2":    25.1865, "y2":   -1.31835, "width":   0.2, "layer": 31 },
    { "x1":        1.0, "y1":   3.955072, "x2":   2.124928, "y2":       5.08, "width":   0.2, "layer": 31 },
    { "x1":        1.0, "y1":     3.3375, "x2":        1.0, "y2":   3.955072, "width":   0.2, "layer": 31 },
    { "x1":   2.124928, "y1":       5.08, "x2":   16.02715, "y2":       5.08, "width":   0.2, "layer": 31 },
    { "x1":   16.02715, "y1":       5.08, "x2":    16.8105, "y2":    5.86335, "width":   0.2, "layer": 31 },
    { "x1":    -3.3375, "y1":        0.5, "x2":    -7.9025, "y2":        0.5, "width":   0.2, "layer": 31 },
    { "x1":    -7.9025, "y1":        0.5, "x2":    -8.8025, "y2":        1.4, "width":   0.2, "layer": 31 },
    { "x1":    -8.8025, "y1":        1.4, "x2":    -8.8025, "y2":        1.6, "width":   0.2, "layer": 31 },
    { "x1":   -10.8605, "y1":        1.6, "x2":    -8.8025, "y2":        1.6, "width":   0.2, "layer": 31 },
    { "x1":        1.5, "y1":   3.889386, "x2":   2.290614, "y2":       4.68, "width":   0.2, "layer": 31 },
    { "x1":        1.5, "y1":     3.3375, "x2":        1.5, "y2":   3.889386, "width":   0.2, "layer": 31 },
    { "x1":    16.0825, "y1":       4.68, "x2":    16.8105, "y2":      3.952, "width":   0.2, "layer": 31 },
    { "x1":   2.290614, "y1":       4.68, "x2":    16.0825, "y2":       4.68, "width":   0.2, "layer": 31 },
    { "x1":    -8.0025, "y1":       -1.6, "x2":    -7.1025, "y2":       -0.7, "width":   0.2, "layer": 31 },
    { "x1":    -3.3375, "y1":        0.0, "x2":       -5.0, "y2":        0.0, "width":   0.2, "layer": 31 },
    { "x1":    -9.8605, "y1":       -1.6, "x2":    -8.0025, "y2":       -1.6, "width":   0.2, "layer": 31 },
    { "x1":       -5.6, "y1":       -0.6, "x2":       -5.0, "y2":        0.0, "width":   0.2, "layer": 31 },
    { "x1":    -7.1025, "y1":       -0.7, "x2":    -7.1025, "y2":       -0.6, "width":   0.2, "layer": 31 },
    { "x1":    -7.1025, "y1":       -0.6, "x2":       -5.6, "y2":       -0.6, "width":   0.2, "layer": 31 },
    { "x1":   -10.8605, "y1":       -0.6, "x2":    -9.8605, "y2":       -1.6, "width":   0.2, "layer": 31 },
    { "x1":        2.5, "y1":    -3.3375, "x2":        2.5, "y2":   -4.18875, "width":   0.2, "layer": 31 },
    { "x1":    3.18675, "y1":    -4.8755, "x2":     6.7145, "y2":    -4.8755, "width":   0.2, "layer": 31 },
    { "x1":     6.7145, "y1":    -4.8755, "x2":     7.4145, "y2":    -4.1755, "width":   0.2, "layer": 31 },
    { "x1":        2.5, "y1":   -4.18875, "x2":    3.18675, "y2":    -4.8755, "width":   0.2, "layer": 31 },
    { "x1":     4.4595, "y1":        2.5, "x2":     5.5095, "y2":       3.55, "width":   0.2, "layer": 31 },
    { "x1":      3.884, "y1":       -2.5, "x2":     5.5095, "y2":    -4.1255, "width":   0.2, "layer": 31 },
    ...
    { "x1":     -13.34, "y1":        1.9, "x2":     -10.38, "y2":       4.86, "width":   0.2, "layer": 31 },
    { "x1":    -3.3375, "y1":        2.0, "x2":  -3.889386, "y2":        2.0, "width":   0.2, "layer": 31 },
    { "x1":  -17.37725, "y1":        1.9, "x2":     -13.34, "y2":        1.9, "width":   0.2, "layer": 31 },
    { "x1":    -4.3955, "y1":   2.506114, "x2":    -4.3955, "y2":      5.157, "width":   0.2, "layer": 31 },
    { "x1":    -4.3955, "y1":      5.157, "x2":    -5.0955, "y2":      5.857, "width":   0.2, "layer": 31 },
    { "x1":     -10.38, "y1":       4.86, "x2":    -6.0925, "y2":       4.86, "width":   0.2, "layer": 31 },
    { "x1":    -6.0925, "y1":       4.86, "x2":    -5.0955, "y2":      5.857, "width":   0.2, "layer": 31 },
    { "x1":  -23.67725, "y1":        1.9, "x2":  -17.37725, "y2":        1.9, "width":   0.2, "layer": 31 },
    { "x1":  -3.889386, "y1":        2.0, "x2":    -4.3955, "y2":   2.506114, "width":   0.2, "layer": 31 },
    { "x1":        0.0, "y1":     3.3375, "x2":        0.0, "y2":   3.889386, "width":   0.2, "layer": 31 },
    { "x1":   1.973964, "y1":    5.86335, "x2":     3.9852, "y2":    5.86335, "width":   0.2, "layer": 31 },
    { "x1":        0.0, "y1":   3.889386, "x2":   1.973964, "y2":    5.86335, "width":   0.2, "layer": 31 },
]
# fmt: on

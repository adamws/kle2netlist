...
V1_TRACKS = [
    { "x1":  -23.67725, "y1":       -1.9, "x2":  -17.37725, "y2":       -1.9, "width":   0.4, "layer": "B.Cu" },
    { "x1":  -23.67725, "y1":        1.9, "x2":  -17.37725, "y2":        1.9, "width":   0.2, "layer": "B.Cu" },
    { "x1":  -17.37725, "y1":       -1.9, "x2":   -13.7105, "y2":       -1.9, "width":   0.4, "layer": "B.Cu" },
    { "x1":  -17.37725, "y1":        1.9, "x2":     -13.65, "y2":        1.9, "width":   0.2, "layer": "B.Cu" },
    ...
    { "x1":   -11.4105, "y1":        2.6, "x2":  -8.002499, "y2":        2.6, "width":   0.2, "layer": "B.Cu" },
    ...
    { "x1":    -9.8605, "y1":       -1.6, "x2":  -8.002499, "y2":       -1.6, "width":   0.2, "layer": "B.Cu" },
    { "x1":    -8.8025, "y1":       -0.6, "x2":    -9.9025, "y2":        0.5, "width":   0.4, "layer": "B.Cu" },
    { "x1":      -8.08, "y1":        3.0, "x2":      -7.62, "y2":       3.46, "width":   0.2, "layer": "B.Cu" },
    { "x1":  -8.002499, "y1":       -1.6, "x2":    -7.1025, "y2":       -0.7, "width":   0.2, "layer": "B.Cu" },
    { "x1":  -8.002499, "y1":        2.6, "x2":    -7.1025, "y2":        1.7, "width":   0.2, "layer": "B.Cu" },
    ...
    { "x1":  -4.750852, "y1":        6.7, "x2":    -5.9025, "y2":        6.7, "width":   0.2, "layer": "B.Cu" },
    { "x1":       -4.5, "y1":        1.5, "x2":    -3.3375, "y2":        1.5, "width":   0.2, "layer": "B.Cu" },
    { "x1":      -4.45, "y1":      -4.12, "x2":      -5.05, "y2":      -4.72, "width":   0.2, "layer": "B.Cu" },
    { "x1":    -4.3955, "y1":     2.2655, "x2":    -4.3955, "y2":   6.344648, "width":   0.2, "layer": "B.Cu" },
    { "x1":    -4.3955, "y1":   6.344648, "x2":  -4.750852, "y2":        6.7, "width":   0.2, "layer": "B.Cu" },
    ...
    { "x1":      -0.71, "y1":   6.309196, "x2":      -0.71, "y2":       5.18, "width":   0.2, "layer": "B.Cu" },
    { "x1":       -0.5, "y1":     3.3375, "x2":       -0.5, "y2":    4.21049, "width":   0.2, "layer": "B.Cu" },
    { "x1":       -0.5, "y1":    4.21049, "x2":    -1.4885, "y2":    5.19899, "width":   0.2, "layer": "B.Cu" },
    { "x1":  -0.380846, "y1":    6.63835, "x2":      -0.71, "y2":   6.309196, "width":   0.2, "layer": "B.Cu" },
    { "x1":        0.0, "y1":       4.47, "x2":        0.0, "y2":     3.3375, "width":   0.2, "layer": "B.Cu" },
    { "x1":     0.0615, "y1":   5.194186, "x2":     0.0615, "y2":      5.857, "width":   0.2, "layer": "B.Cu" },
    { "x1":        0.5, "y1":     3.3375, "x2":        0.5, "y2":        0.5, "width":   0.2, "layer": "B.Cu" },
    { "x1":        0.5, "y1":     3.3375, "x2":        0.5, "y2":   4.755686, "width":   0.2, "layer": "B.Cu" },
    { "x1":        0.5, "y1":   4.755686, "x2":     0.0615, "y2":   5.194186, "width":   0.2, "layer": "B.Cu" },
    { "x1":        1.0, "y1":     3.3375, "x2":        1.0, "y2":   4.218628, "width":   0.2, "layer": "B.Cu" },
    { "x1":        1.0, "y1":   4.218628, "x2":   1.861372, "y2":       5.08, "width":   0.2, "layer": "B.Cu" },
    { "x1":        1.5, "y1":     3.3375, "x2":        1.5, "y2":   4.152942, "width":   0.2, "layer": "B.Cu" },
    { "x1":        1.5, "y1":   4.152942, "x2":   2.027057, "y2":       4.68, "width":   0.2, "layer": "B.Cu" },
    { "x1":      1.725, "y1":    5.86335, "x2":    0.06785, "y2":    5.86335, "width":   0.4, "layer": "B.Cu" },
    { "x1":   1.861372, "y1":       5.08, "x2":      15.33, "y2":       5.08, "width":   0.2, "layer": "B.Cu" },
    { "x1":        2.0, "y1":     3.3375, "x2":        2.0, "y2":   4.087256, "width":   0.2, "layer": "B.Cu" },
    { "x1":        2.0, "y1":   4.087256, "x2":   2.192744, "y2":       4.28, "width":   0.2, "layer": "B.Cu" },
    { "x1":   2.027057, "y1":       4.68, "x2":      15.32, "y2":       4.68, "width":   0.2, "layer": "B.Cu" },
    { "x1":   2.192744, "y1":       4.28, "x2":     4.7795, "y2":       4.28, "width":   0.2, "layer": "B.Cu" },
    { "x1":        2.5, "y1":  -4.188748, "x2":    3.18675, "y2":    -4.8755, "width":   0.2, "layer": "B.Cu" },
    { "x1":        2.5, "y1":    -3.3375, "x2":        2.5, "y2":  -4.188748, "width":   0.2, "layer": "B.Cu" },
    { "x1":        2.5, "y1":    6.63835, "x2":  -0.380846, "y2":    6.63835, "width":   0.2, "layer": "B.Cu" },
    { "x1":     2.8295, "y1":     -5.446, "x2":       4.15, "y2":  -4.125498, "width":   0.4, "layer": "F.Cu" },
    ...
    { "x1":      3.884, "y1":       -2.5, "x2":     5.5095, "y2":  -4.125498, "width":   0.2, "layer": "B.Cu" },
    { "x1":       4.15, "y1":  -4.125498, "x2":      5.099, "y2":    -5.0745, "width":   0.4, "layer": "F.Cu" },
    ...
    { "x1":     5.5095, "y1":  -4.125498, "x2":       4.15, "y2":  -4.125498, "width":   0.4, "layer": "B.Cu" },
    ...
    { "x1":       8.35, "y1":        2.0, "x2":  20.709125, "y2":        2.0, "width":   0.4, "layer": "F.Cu" },
    ...
    { "x1":    18.4605, "y1":      3.952, "x2":  19.175676, "y2":      3.952, "width":   0.2, "layer": "B.Cu" },
    { "x1":    18.4605, "y1":    5.86335, "x2":  19.173001, "y2":    5.86335, "width":   0.2, "layer": "B.Cu" },
    { "x1":  19.173001, "y1":   5.860675, "x2":  19.953676, "y2":       5.08, "width":   0.2, "layer": "B.Cu" },
    { "x1":  19.173001, "y1":    5.86335, "x2":  19.173001, "y2":   5.860675, "width":   0.2, "layer": "B.Cu" },
    { "x1":  19.175676, "y1":      3.952, "x2":  19.903676, "y2":       4.68, "width":   0.2, "layer": "B.Cu" },
    { "x1":  19.903676, "y1":       4.68, "x2":      22.64, "y2":       4.68, "width":   0.2, "layer": "B.Cu" },
    { "x1":  19.953676, "y1":       5.08, "x2":       24.5, "y2":       5.08, "width":   0.2, "layer": "B.Cu" },
    ...
    { "x1":    22.0865, "y1":      -0.25, "x2":    22.0865, "y2":   0.622625, "width":   0.4, "layer": "F.Cu" },
    { "x1":    22.0865, "y1":   0.622625, "x2":  20.709125, "y2":        2.0, "width":   0.4, "layer": "F.Cu" },
    ...
    { "x1":     25.624, "y1":      1.285, "x2":  26.436499, "y2":      1.285, "width":   0.4, "layer": "B.Cu" },
    { "x1":     25.624, "y1":      3.956, "x2":     25.624, "y2":      2.235, "width":   0.2, "layer": "B.Cu" },
    { "x1":   26.00485, "y1":      -3.75, "x2":    26.7365, "y2":   -3.01835, "width":   0.2, "layer": "B.Cu" },
    { "x1":  26.436499, "y1":      1.285, "x2":    26.8865, "y2":   0.834999, "width":   0.4, "layer": "B.Cu" },
    { "x1":    26.7365, "y1":   -3.01835, "x2":    26.7365, "y2":   -2.19335, "width":   0.2, "layer": "B.Cu" },
    { "x1":    26.8865, "y1":   0.834999, "x2":    26.8865, "y2":   -2.19335, "width":   0.4, "layer": "B.Cu" },
...
V1_TRACKS_FANOUT = {
    "PB0": [
        { "x1":    -2.3955, "y1":   5.540304, "x2":    -2.3955, "y2":     7.4445, "width":   0.2, "layer": "B.Cu" },
        { "x1":       -1.0, "y1":     3.3375, "x2":       -1.0, "y2":   4.144804, "width":   0.2, "layer": "B.Cu" },
        { "x1":       -1.0, "y1":   4.144804, "x2":    -2.3955, "y2":   5.540304, "width":   0.2, "layer": "B.Cu" },
    ],
    "PB1": [
        { "x1":    -2.7955, "y1":   5.374618, "x2":    -2.7955, "y2":     7.4445, "width":   0.2, "layer": "B.Cu" },
        { "x1":       -1.5, "y1":     3.3375, "x2":       -1.5, "y2":   4.079118, "width":   0.2, "layer": "B.Cu" },
        { "x1":       -1.5, "y1":   4.079118, "x2":    -2.7955, "y2":   5.374618, "width":   0.2, "layer": "B.Cu" },
    ],
    "PB2": [
        { "x1":    -3.1955, "y1":   5.208932, "x2":    -3.1955, "y2":     7.4445, "width":   0.2, "layer": "B.Cu" },
        { "x1":       -2.0, "y1":     3.3375, "x2":       -2.0, "y2":   4.013432, "width":   0.2, "layer": "B.Cu" },
        { "x1":       -2.0, "y1":   4.013432, "x2":    -3.1955, "y2":   5.208932, "width":   0.2, "layer": "B.Cu" },
    ],
    "PB3": [
        { "x1":    -3.5955, "y1":   5.043246, "x2":    -3.5955, "y2":     7.4445, "width":   0.2, "layer": "B.Cu" },
        { "x1":       -2.5, "y1":     3.3375, "x2":       -2.5, "y2":   3.947746, "width":   0.2, "layer": "B.Cu" },
        { "x1":       -2.5, "y1":   3.947746, "x2":    -3.5955, "y2":   5.043246, "width":   0.2, "layer": "B.Cu" },
    ],
    "PB4": [
        { "x1":        0.0, "y1":    -3.3375, "x2":        0.0, "y2":     -6.146, "width":   0.2, "layer": "B.Cu" },
    ],
    "PB7": [
    ...
    "PB5": [
        { "x1":        0.5, "y1":    -3.3375, "x2":        0.5, "y2":     -6.146, "width":   0.2, "layer": "B.Cu" },
    ],
    "PB6": [
        { "x1":        1.0, "y1":    -3.3375, "x2":        1.0, "y2":     -6.146, "width":   0.2, "layer": "B.Cu" },
    ],
    "PC6": [
        { "x1":        1.5, "y1":    -3.3375, "x2":        1.5, "y2":     -6.146, "width":   0.2, "layer": "B.Cu" },
    ],
    "PC7": [
        { "x1":        2.0, "y1":    -3.3375, "x2":        2.0, "y2":     -6.146, "width":   0.2, "layer": "B.Cu" },
    ],
    "PD0": [
        { "x1":  -6.694314, "y1":      -2.26, "x2":       -8.0, "y2":      -2.26, "width":   0.2, "layer": "B.Cu" },
        { "x1":  -4.934314, "y1":       -0.5, "x2":  -6.694314, "y2":      -2.26, "width":   0.2, "layer": "B.Cu" },
        { "x1":    -3.3375, "y1":       -0.5, "x2":  -4.934314, "y2":       -0.5, "width":   0.2, "layer": "B.Cu" },
    ],
    "PD1": [
        { "x1":  -6.528628, "y1":      -2.66, "x2":       -8.0, "y2":      -2.66, "width":   0.2, "layer": "B.Cu" },
        { "x1":  -4.868628, "y1":       -1.0, "x2":  -6.528628, "y2":      -2.66, "width":   0.2, "layer": "B.Cu" },
        { "x1":    -3.3375, "y1":       -1.0, "x2":  -4.868628, "y2":       -1.0, "width":   0.2, "layer": "B.Cu" },
    ],
    "PD2": [
        { "x1":  -6.362942, "y1":      -3.06, "x2":       -8.0, "y2":      -3.06, "width":   0.2, "layer": "B.Cu" },
        { "x1":  -4.802942, "y1":       -1.5, "x2":  -6.362942, "y2":      -3.06, "width":   0.2, "layer": "B.Cu" },
        { "x1":    -3.3375, "y1":       -1.5, "x2":  -4.802942, "y2":       -1.5, "width":   0.2, "layer": "B.Cu" },
    ],
    "PD3": [
        { "x1":  -6.197256, "y1":      -3.46, "x2":       -8.0, "y2":      -3.46, "width":   0.2, "layer": "B.Cu" },
        { "x1":  -4.737256, "y1":       -2.0, "x2":  -6.197256, "y2":      -3.46, "width":   0.2, "layer": "B.Cu" },
        { "x1":    -3.3375, "y1":       -2.0, "x2":  -4.737256, "y2":       -2.0, "width":   0.2, "layer": "B.Cu" },
    ],
    "PD4": [
        { "x1":       -1.5, "y1":    -3.3375, "x2":       -1.5, "y2":     -6.146, "width":   0.2, "layer": "B.Cu" },
    ],
    "PD5": [
        { "x1":   -6.03157, "y1":      -3.86, "x2":       -8.0, "y2":      -3.86, "width":   0.2, "layer": "B.Cu" },
        { "x1":   -4.67157, "y1":       -2.5, "x2":   -6.03157, "y2":      -3.86, "width":   0.2, "layer": "B.Cu" },
        { "x1":    -3.3375, "y1":       -2.5, "x2":   -4.67157, "y2":       -2.5, "width":   0.2, "layer": "B.Cu" },
    ],
    "PD6": [
        { "x1":       -1.0, "y1":    -3.3375, "x2":       -1.0, "y2":      -6.14, "width":   0.2, "layer": "B.Cu" },
    ],
    "PD7": [
        { "x1":       -0.5, "y1":    -3.3375, "x2":       -0.5, "y2":      -6.13, "width":   0.2, "layer": "B.Cu" },
    ],
    "PF0": [
        { "x1":     3.3375, "y1":        1.0, "x2":       9.04, "y2":        1.0, "width":   0.2, "layer": "B.Cu" },
    ],
    "PF1": [
        { "x1":     3.3375, "y1":        0.5, "x2":       9.04, "y2":        0.5, "width":   0.2, "layer": "B.Cu" },
    ],
    "PF4": [
        { "x1":     3.3375, "y1":        0.0, "x2":       9.04, "y2":        0.0, "width":   0.2, "layer": "B.Cu" },
    ],
    "PF5": [
        { "x1":     3.3375, "y1":       -0.5, "x2":       9.04, "y2":       -0.5, "width":   0.2, "layer": "B.Cu" },
    ],
    ...
    "PF7": [
        { "x1":     3.3375, "y1":       -1.5, "x2":       9.04, "y2":       -1.5, "width":   0.2, "layer": "B.Cu" },
    ],
}
V1_VIAS = [
    { "x":   -11.3105, "y":        0.5 },

...
V1_TRACKS = [
    ...
    { "x1":      -5.05, "y1":     -5.446, "x2":      -6.28, "y2":     -5.446, "width":   0.4, "layer": 31 },
    { "x1":      -5.05, "y1":      -4.72, "x2":      -5.05, "y2":     -5.446, "width":   0.2, "layer": 31 },
    { "x1":  -4.750852, "y1":        6.7, "x2":    -5.9025, "y2":        6.7, "width":   0.2, "layer": 31 },
    { "x1":       -4.5, "y1":        1.5, "x2":    -3.3375, "y2":        1.5, "width":   0.2, "layer": 31 },
    { "x1":      -4.45, "y1":      -4.12, "x2":      -5.05, "y2":      -4.72, "width":   0.2, "layer": 31 },
    { "x1":    -4.3955, "y1":     2.2655, "x2":    -4.3955, "y2":   6.344648, "width":   0.2, "layer": 31 },
    { "x1":    -4.3955, "y1":   6.344648, "x2":  -4.750852, "y2":        6.7, "width":   0.2, "layer": 31 },
    { "x1":      -4.13, "y1":        2.0, "x2":    -4.3955, "y2":     2.2655, "width":   0.2, "layer": 31 },
    { "x1":     -3.664, "y1":     4.9045, "x2":    -5.9205, "y2":     4.9045, "width":   0.4, "layer":  0 },
    { "x1":       -3.5, "y1":       -4.7, "x2":       -3.5, "y2":     -5.446, "width":   0.2, "layer": 31 },
    ...
    { "x1":    -3.3375, "y1":        2.0, "x2":      -4.13, "y2":        2.0, "width":   0.2, "layer": 31 },
    { "x1":      -3.32, "y1":      -4.52, "x2":       -3.5, "y2":       -4.7, "width":   0.2, "layer": 31 },
    { "x1":      -2.72, "y1":      -4.12, "x2":      -4.45, "y2":      -4.12, "width":   0.2, "layer": 31 },
    { "x1":       -2.5, "y1":       -3.9, "x2":      -2.72, "y2":      -4.12, "width":   0.2, "layer": 31 },
    { "x1":       -2.5, "y1":    -3.3375, "x2":       -2.5, "y2":       -3.9, "width":   0.2, "layer": 31 },
    { "x1":       -2.5, "y1":    -3.3375, "x2":       -2.5, "y2":       -2.5, "width":   0.2, "layer": 31 },
    { "x1":      -2.23, "y1":      -4.52, "x2":      -3.32, "y2":      -4.52, "width":   0.2, "layer": 31 },
    { "x1":       -2.2, "y1":     -5.446, "x2":       -3.5, "y2":     -5.446, "width":   0.4, "layer": 31 },
    { "x1":       -2.2, "y1":     -5.446, "x2":     2.8295, "y2":     -5.446, "width":   0.4, "layer":  0 },
    { "x1":       -2.0, "y1":      -4.29, "x2":      -2.23, "y2":      -4.52, "width":   0.2, "layer": 31 },
    { "x1":       -2.0, "y1":    -3.3375, "x2":       -2.0, "y2":      -4.29, "width":   0.2, "layer": 31 },
    { "x1":    -1.4885, "y1":    5.19899, "x2":    -1.4885, "y2":      5.857, "width":   0.2, "layer": 31 },
    { "x1":    -1.4885, "y1":      5.857, "x2":    -1.4885, "y2":       7.08, "width":   0.4, "layer": 31 },
    { "x1":    -1.4885, "y1":       7.08, "x2":     -3.664, "y2":     4.9045, "width":   0.4, "layer":  0 },
    { "x1":      -0.71, "y1":       5.18, "x2":        0.0, "y2":       4.47, "width":   0.2, "layer": 31 },
    { "x1":      -0.71, "y1":   6.309196, "x2":      -0.71, "y2":       5.18, "width":   0.2, "layer": 31 },
    { "x1":       -0.5, "y1":     3.3375, "x2":       -0.5, "y2":    4.21049, "width":   0.2, "layer": 31 },
    { "x1":       -0.5, "y1":    4.21049, "x2":    -1.4885, "y2":    5.19899, "width":   0.2, "layer": 31 },
    { "x1":  -0.380846, "y1":    6.63835, "x2":      -0.71, "y2":   6.309196, "width":   0.2, "layer": 31 },
    { "x1":        0.0, "y1":       4.47, "x2":        0.0, "y2":     3.3375, "width":   0.2, "layer": 31 },
    { "x1":     0.0615, "y1":   5.194186, "x2":     0.0615, "y2":      5.857, "width":   0.2, "layer": 31 },
    { "x1":        0.5, "y1":     3.3375, "x2":        0.5, "y2":        0.5, "width":   0.2, "layer": 31 },
    { "x1":        0.5, "y1":     3.3375, "x2":        0.5, "y2":   4.755686, "width":   0.2, "layer": 31 },
    { "x1":        0.5, "y1":   4.755686, "x2":     0.0615, "y2":   5.194186, "width":   0.2, "layer": 31 },
    ...
    { "x1":     2.8295, "y1":     -5.446, "x2":       4.15, "y2":  -4.125498, "width":   0.4, "layer":  0 },
    ...
    { "x1":       8.35, "y1":      -4.12, "x2":       8.35, "y2":        2.0, "width":   0.4, "layer":  0 },
    { "x1":       8.35, "y1":        2.0, "x2":  20.709125, "y2":        2.0, "width":   0.4, "layer":  0 },
    { "x1":      15.32, "y1":       4.68, "x2":     16.048, "y2":      3.952, "width":   0.2, "layer": 31 },
    { "x1":      15.33, "y1":       5.08, "x2":   16.11335, "y2":    5.86335, "width":   0.2, "layer": 31 },
    { "x1":     16.048, "y1":      3.952, "x2":    16.8105, "y2":      3.952, "width":   0.2, "layer": 31 },
    { "x1":   16.11335, "y1":    5.86335, "x2":    16.8105, "y2":    5.86335, "width":   0.2, "layer": 31 },
    { "x1":    18.4605, "y1":      3.952, "x2":  19.175676, "y2":      3.952, "width":   0.2, "layer": 31 },
    { "x1":    18.4605, "y1":    5.86335, "x2":  19.173001, "y2":    5.86335, "width":   0.2, "layer": 31 },
    { "x1":  19.173001, "y1":   5.860675, "x2":  19.953676, "y2":       5.08, "width":   0.2, "layer": 31 },
    { "x1":  19.173001, "y1":    5.86335, "x2":  19.173001, "y2":   5.860675, "width":   0.2, "layer": 31 },
    { "x1":  19.175676, "y1":      3.952, "x2":  19.903676, "y2":       4.68, "width":   0.2, "layer": 31 },
    { "x1":  19.903676, "y1":       4.68, "x2":      22.64, "y2":       4.68, "width":   0.2, "layer": 31 },
    { "x1":  19.953676, "y1":       5.08, "x2":       24.5, "y2":       5.08, "width":   0.2, "layer": 31 },
    { "x1":     19.975, "y1":        1.6, "x2":       8.18, "y2":        1.6, "width":   0.4, "layer": 31 },
    ...
    { "x1":    21.2865, "y1":     0.2865, "x2":    21.2865, "y2":   -2.19335, "width":   0.4, "layer": 31 },
    { "x1":    21.2865, "y1":     0.2865, "x2":    21.2865, "y2":     0.2885, "width":   0.4, "layer": 31 },
    { "x1":    21.2865, "y1":     0.2885, "x2":     19.975, "y2":        1.6, "width":   0.4, "layer": 31 },
    { "x1":    22.0865, "y1":      -0.25, "x2":    22.0865, "y2":   -2.19335, "width":   0.4, "layer": 31 },
    { "x1":    22.0865, "y1":      -0.25, "x2":    22.0865, "y2":   0.622625, "width":   0.4, "layer":  0 },
    { "x1":    22.0865, "y1":   0.622625, "x2":  20.709125, "y2":        2.0, "width":   0.4, "layer":  0 },
    { "x1":    22.2365, "y1":    -2.9865, "x2":       23.0, "y2":      -3.75, "width":   0.2, "layer": 31 },
    { "x1":    22.2365, "y1":   -2.19335, "x2":    22.2365, "y2":    -2.9865, "width":   0.2, "layer": 31 },
    { "x1":     22.285, "y1":      1.285, "x2":    21.2865, "y2":     0.2865, "width":   0.4, "layer": 31 },
    { "x1":      22.64, "y1":       4.68, "x2":     23.349, "y2":      3.971, "width":   0.2, "layer": 31 },
    { "x1":       23.0, "y1":      -3.75, "x2":   26.00485, "y2":      -3.75, "width":   0.2, "layer": 31 },
    { "x1":     23.349, "y1":     -0.449, "x2":     23.349, "y2":      0.335, "width":   0.2, "layer": 31 },
    { "x1":     23.349, "y1":      1.285, "x2":     22.285, "y2":      1.285, "width":   0.4, "layer": 31 },
    { "x1":     23.349, "y1":      3.971, "x2":     23.349, "y2":      2.235, "width":   0.2, "layer": 31 },
    ...
    { "x1":       24.5, "y1":       5.08, "x2":     25.624, "y2":      3.956, "width":   0.2, "layer": 31 },
    ...
    { "x1":     25.624, "y1":      3.956, "x2":     25.624, "y2":      2.235, "width":   0.2, "layer": 31 },
...
V1_TRACKS_FANOUT = {
    ...
    "PB4": [
        { "x1":        0.0, "y1":    -3.3375, "x2":        0.0, "y2":     -6.146, "width":   0.2, "layer": 31 },
    ],
    "PB7": [
    ...
    "PB5": [
        { "x1":        0.5, "y1":    -3.3375, "x2":        0.5, "y2":     -6.146, "width":   0.2, "layer": 31 },
    ],
    "PB6": [
        { "x1":        1.0, "y1":    -3.3375, "x2":        1.0, "y2":     -6.146, "width":   0.2, "layer": 31 },
    ],
    "PC6": [
        { "x1":        1.5, "y1":    -3.3375, "x2":        1.5, "y2":     -6.146, "width":   0.2, "layer": 31 },
    ],
    "PC7": [
        { "x1":        2.0, "y1":    -3.3375, "x2":        2.0, "y2":     -6.146, "width":   0.2, "layer": 31 },
    ],
    "PD0": [
        { "x1":  -6.694314, "y1":      -2.26, "x2":       -8.0, "y2":      -2.26, "width":   0.2, "layer": 31 },
        { "x1":  -4.934314, "y1":       -0.5, "x2":  -6.694314, "y2":      -2.26, "width":   0.2, "layer": 31 },
        { "x1":    -3.3375, "y1":       -0.5, "x2":  -4.934314, "y2":       -0.5, "width":   0.2, "layer": 31 },
    ],
    "PD1": [
        { "x1":  -6.528628, "y1":      -2.66, "x2":       -8.0, "y2":      -2.66, "width":   0.2, "layer": 31 },
        { "x1":  -4.868628, "y1":       -1.0, "x2":  -6.528628, "y2":      -2.66, "width":   0.2, "layer": 31 },
        { "x1":    -3.3375, "y1":       -1.0, "x2":  -4.868628, "y2":       -1.0, "width":   0.2, "layer": 31 },
    ],
    "PD2": [
        { "x1":  -6.362942, "y1":      -3.06, "x2":       -8.0, "y2":      -3.06, "width":   0.2, "layer": 31 },
        { "x1":  -4.802942, "y1":       -1.5, "x2":  -6.362942, "y2":      -3.06, "width":   0.2, "layer": 31 },
        { "x1":    -3.3375, "y1":       -1.5, "x2":  -4.802942, "y2":       -1.5, "width":   0.2, "layer": 31 },
    ],
    "PD3": [
        { "x1":  -6.197256, "y1":      -3.46, "x2":       -8.0, "y2":      -3.46, "width":   0.2, "layer": 31 },
        { "x1":  -4.737256, "y1":       -2.0, "x2":  -6.197256, "y2":      -3.46, "width":   0.2, "layer": 31 },
        { "x1":    -3.3375, "y1":       -2.0, "x2":  -4.737256, "y2":       -2.0, "width":   0.2, "layer": 31 },
    ],
    "PD4": [
        { "x1":       -1.5, "y1":    -3.3375, "x2":       -1.5, "y2":     -6.146, "width":   0.2, "layer": 31 },
    ],
    "PD5": [
        { "x1":   -6.03157, "y1":      -3.86, "x2":       -8.0, "y2":      -3.86, "width":   0.2, "layer": 31 },
        { "x1":   -4.67157, "y1":       -2.5, "x2":   -6.03157, "y2":      -3.86, "width":   0.2, "layer": 31 },
        { "x1":    -3.3375, "y1":       -2.5, "x2":   -4.67157, "y2":       -2.5, "width":   0.2, "layer": 31 },
    ],
    "PD6": [
        { "x1":       -1.0, "y1":    -3.3375, "x2":       -1.0, "y2":      -6.14, "width":   0.2, "layer": 31 },
    ],
    "PD7": [
        { "x1":       -0.5, "y1":    -3.3375, "x2":       -0.5, "y2":      -6.13, "width":   0.2, "layer": 31 },
    ],
    "PF0": [
        { "x1":     3.3375, "y1":        1.0, "x2":       9.04, "y2":        1.0, "width":   0.2, "layer": 31 },
    ],
    "PF1": [
        { "x1":     3.3375, "y1":        0.5, "x2":       9.04, "y2":        0.5, "width":   0.2, "layer": 31 },
    ],
    "PF4": [
        { "x1":     3.3375, "y1":        0.0, "x2":       9.04, "y2":        0.0, "width":   0.2, "layer": 31 },
    ],
    "PF5": [
        { "x1":     3.3375, "y1":       -0.5, "x2":       9.04, "y2":       -0.5, "width":   0.2, "layer": 31 },
    ],
    ...
    "PF7": [
        { "x1":     3.3375, "y1":       -1.5, "x2":       9.04, "y2":       -1.5, "width":   0.2, "layer": 31 },
    ],
}
V1_VIAS = [
    { "x":   -11.3105, "y":        0.5 },
